...
BEGIN DRIVER
 PARAMETER DRIVER_NAME = axi_lite
 PARAMETER DRIVER_VER = 1.0
 PARAMETER HW_INSTANCE = axi_lite_0
END

BEGIN DRIVER
 PARAMETER DRIVER_NAME = gpio
 PARAMETER DRIVER_VER = 4.5
 PARAMETER HW_INSTANCE = gpio_user_rstn
END

BEGIN DRIVER
 PARAMETER DRIVER_NAME = gpio
 PARAMETER DRIVER_VER = 4.5
 PARAMETER HW_INSTANCE = gpio_user_start
END
...
BEGIN DRIVER
 PARAMETER DRIVER_NAME = generic
 PARAMETER DRIVER_VER = 2.0
 PARAMETER HW_INSTANCE = uifdma_dbuf_0
END
