...
-- Date        : Mon Aug 28 11:51:02 2023
-- Host        : MJ_FPGA running 64-bit major release  (build 9200)
-- Command     : write_vhdl -force -mode funcsim
--               d:/12_RFMU/RFMU_v0_5_3/soc_prj/zed_9361/zed_9361.srcs/sources_1/bd/design_1/ip/design_1_uiFDMA_0_0/design_1_uiFDMA_0_0_sim_netlist.vhdl
...
entity design_1_uiFDMA_0_0_uiFDMA is
  port (
    fdma_wready_0 : out STD_LOGIC;
    fdma_rready_0 : out STD_LOGIC;
...
architecture STRUCTURE of design_1_uiFDMA_0_0_uiFDMA is
  ...
  signal axi_rlast0_carry_i_6_n_0 : STD_LOGIC;
  ...
  signal axi_wlast0_carry_i_6_n_0 : STD_LOGIC;
  ...
  signal \^fdma_rready_0\ : STD_LOGIC;
  ...
  signal \^fdma_wready_0\ : STD_LOGIC;
  ...
  attribute SOFT_HLUTNM of \M_AXI_ARLEN[0]_INST_0\ : label is "soft_lutpair13";
  attribute SOFT_HLUTNM of \M_AXI_ARLEN[1]_INST_0\ : label is "soft_lutpair13";
  attribute SOFT_HLUTNM of \M_AXI_ARLEN[2]_INST_0\ : label is "soft_lutpair12";
  attribute SOFT_HLUTNM of \M_AXI_ARLEN[3]_INST_0\ : label is "soft_lutpair1";
  attribute SOFT_HLUTNM of \M_AXI_ARLEN[4]_INST_0\ : label is "soft_lutpair3";
  attribute SOFT_HLUTNM of \M_AXI_ARLEN[7]_INST_0_i_1\ : label is "soft_lutpair12";
  ...
  attribute SOFT_HLUTNM of axi_rlast0_carry_i_5 : label is "soft_lutpair1";
  attribute SOFT_HLUTNM of axi_rlast0_carry_i_6 : label is "soft_lutpair3";
  attribute SOFT_HLUTNM of axi_wlast0_carry_i_5 : label is "soft_lutpair4";
  attribute SOFT_HLUTNM of axi_wlast0_carry_i_6 : label is "soft_lutpair5";
  attribute SOFT_HLUTNM of \rburst_cnt[1]_i_1\ : label is "soft_lutpair10";
  ...
  attribute SOFT_HLUTNM of \rburst_cnt[7]_i_1\ : label is "soft_lutpair7";
  attribute SOFT_HLUTNM of \rburst_cnt[8]_i_2\ : label is "soft_lutpair7";
  attribute SOFT_HLUTNM of \wburst_cnt[1]_i_1\ : label is "soft_lutpair11";
  ...
  attribute SOFT_HLUTNM of \wburst_cnt[7]_i_1\ : label is "soft_lutpair6";
  attribute SOFT_HLUTNM of \wburst_cnt[8]_i_2\ : label is "soft_lutpair6";
begin
...
axi_rlast0_carry_i_2: unisim.vcomponents.LUT6
    generic map(
      INIT => X"8040400808040480"
        ...
        port map (
      I0 => rburst_cnt_reg(4),
      I1 => axi_rlast0_carry_i_5_n_0,
      I2 => rburst_cnt_reg(5),
      I3 => axi_rburst_size(8),
      I4 => axi_rlast0_carry_i_6_n_0,
...
axi_rlast0_carry_i_6: unisim.vcomponents.LUT4
    generic map(
      INIT => X"FFFE"
    )
        port map (
...
axi_wlast0_carry_i_2: unisim.vcomponents.LUT6
    generic map(
      INIT => X"8040400808040480"
        ...
        port map (
      I0 => wburst_cnt_reg(4),
      I1 => axi_wlast0_carry_i_5_n_0,
      I2 => wburst_cnt_reg(5),
      I3 => axi_wburst_size(8),
      I4 => axi_wlast0_carry_i_6_n_0,
...
axi_wlast0_carry_i_6: unisim.vcomponents.LUT4
    generic map(
      INIT => X"FFFE"
    )
        port map (
...
fdma_wstart_locked_i_2: unisim.vcomponents.LUT6
    generic map(
      ...
      I1 => \fdma_wleft_cnt_reg_n_0_[7]\,
      I2 => \fdma_wleft_cnt_reg_n_0_[6]\,
      I3 => \fdma_wleft_cnt_reg_n_0_[5]\,
      I4 => \fdma_wleft_cnt_reg_n_0_[4]\,
      I5 => \^fdma_wready_0\,
      O => fdma_wstart_locked_i_2_n_0
    );
fdma_wstart_locked_i_3: unisim.vcomponents.LUT5
    generic map(
      INIT => X"FFFFFFFE"
    )
        port map (
...
\rburst_len[8]_i_1\: unisim.vcomponents.LUT6
    generic map(
      ...
      I1 => \fdma_rleft_cnt_reg_n_0_[8]\,
      I2 => \fdma_rleft_cnt_reg_n_0_[9]\,
      I3 => \fdma_rleft_cnt_reg_n_0_[10]\,
      I4 => \fdma_rleft_cnt_reg_n_0_[11]\,
      I5 => rburst_len_req,
      O => rburst_len
    );
...
entity design_1_uiFDMA_0_0 is
  ...
  attribute X_CORE_INFO of design_1_uiFDMA_0_0 : entity is "uiFDMA,Vivado 2019.2";
...
architecture STRUCTURE of design_1_uiFDMA_0_0 is
  ...
  attribute X_INTERFACE_PARAMETER of M_AXI_ACLK : signal is "XIL_INTERFACENAME M_AXI_ACLK, ASSOCIATED_BUSIF M_AXI, ASSOCIATED_RESET M_AXI_ARESETN, FREQ_HZ 100000000, PHASE 0.000, CLK_DOMAIN design_1_processing_system7_0_0_FCLK_CLK0, INSERT_VIP 0";
