...
HD_PWD='F:/Ming_Jian/16QAM/16M_16QAM/zed_9361_1107_1Msys/zed_9361_1107_1Msys/zed_9361.runs/blk_mem_gen_I_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log blk_mem_gen_I.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source blk_mem_gen_I.tcl
