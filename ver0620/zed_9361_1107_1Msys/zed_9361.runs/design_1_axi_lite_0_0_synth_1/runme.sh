...
HD_PWD='D:/12_RFMU/RFMU_v0_5_3/soc_prj/zed_9361/zed_9361.runs/design_1_axi_lite_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log design_1_axi_lite_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source design_1_axi_lite_0_0.tcl
