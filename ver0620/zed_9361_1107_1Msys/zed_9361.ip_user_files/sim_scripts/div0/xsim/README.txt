...
#
# Generated by export_simulation on Thu Nov 02 17:22:27 +0800 2023
#
################################################################################
...
'-reset_run' switch to the './div0.sh' script.
...
./div0.sh -noclean_files

For more information on the script, please type './div0.sh -help'.
