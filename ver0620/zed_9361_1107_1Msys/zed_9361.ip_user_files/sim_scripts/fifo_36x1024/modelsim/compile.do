...
vlog -work xilinx_vip -64 -incr -sv -L axi_vip_v1_1_6 -L processing_system7_vip_v1_0_8 -L xilinx_vip "+incdir+H:/VIVADO2019.2/Vivado/2019.2/data/xilinx_vip/include" \
...
vlog -work xpm -64 -incr -sv -L axi_vip_v1_1_6 -L processing_system7_vip_v1_0_8 -L xilinx_vip "+incdir+H:/VIVADO2019.2/Vivado/2019.2/data/xilinx_vip/include" \
...
vlog -work fifo_generator_v13_2_5 -64 -incr "+incdir+H:/VIVADO2019.2/Vivado/2019.2/data/xilinx_vip/include" \
...
vlog -work xil_defaultlib -64 -incr "+incdir+H:/VIVADO2019.2/Vivado/2019.2/data/xilinx_vip/include" \
"../../../../zed_9361.srcs/sources_1/ip/fifo_36x1024/sim/fifo_36x1024.v" \
