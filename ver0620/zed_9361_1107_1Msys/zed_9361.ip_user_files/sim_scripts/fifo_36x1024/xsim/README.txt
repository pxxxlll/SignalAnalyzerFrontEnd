...
#
# Generated by export_simulation on Thu Jan 18 13:51:58 +0800 2024
#
################################################################################
...
'-reset_run' switch to the './fifo_36x1024.sh' script.

./fifo_36x1024.sh -reset_run
...
./fifo_36x1024.sh -noclean_files

For more information on the script, please type './fifo_36x1024.sh -help'.
